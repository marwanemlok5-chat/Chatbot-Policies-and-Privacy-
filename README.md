...
<head>
    ...
    <style>
        * {
        ...
        /* Content area — preserve original text exactly */
        .policy-content {
            position: relative;
            z-index: 1;
            margin: 10px 0 18px;
        ...
        /* preserve original headings inside content */
        .policy-content h1,
        .policy-content h6,
        .policy-content h3 {
            color: #f0f4ff;
...
<body>
    <div class="glass-card">
        ...
        <!-- Profile + Title + Read Button -->
        <div class="profile-section">
            <img class="profile-avatar" src="bfd8c880-8807-11f1-8108-b3a8e4e1fe89.png" alt="شعار البوت" onerror="this.style.display='none'">
            <div class="header-text">
                <h1>سياسات والخصوصية شات بوت</h1>
                <div class="sub-date">الإثنين 10 اغسطس 2026</div>
            </div>
            <button class="read-btn" id="readAloudBtn" aria-label="قراءة النص بصوت">
                <svg viewBox="0 0 24 24"><path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z"/></svg>
            </button>
        </div>

        <!-- Policy content – preserved exactly as provided (with original headings) -->
    ...
    <script>
        (function() {
            ...
            // Get clean text from the policy div (including all headings and paragraphs)
            function getPolicyText() {
                // We want the full text content, but we need to preserve structure.
                // Using innerText gives plain text without HTML tags, which is good for speech.
